/*
 * 更新时间: 2021-9-22
 * TG频道: https://t.me/joinchat/AAAAAE7rKoq4s-WIv3OfrA
 */
/*
小米运动修改微信支付宝运动步数
APP Store下载小米运动APP
...
[MITM]
hostname = account.huami.com, account-cn2.huami.com
Surge
[Script]
...
[task_local]
# 小米运动
15 17 * * * https://raw.githubusercontent.com/PoetryU/Scientist/master/Scripts/xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/(^account)\.huami\.com\/v2\/client\/login url script-response-body https://raw.githubusercontent.com/PoetryU/Scientist/master/Scripts/xmSports.js
Loon
[Script]
cron "15 17 * * *" script-path=xmbs.js, tag=小米运动
http-response ^https:\/\/(^account)\.huami\.com\/v2\/client\/login script-path=https://raw.githubusercontent.com/PoetryU/Scientist/master/Scripts/xmSports.js, requires-body=true, timeout=3600, tag=小米运动获取Token
 */
